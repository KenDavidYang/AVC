...
<body>
    <div class="navigation-bar">
        ...
        <div class="navigation-bar-middle">
            <a class="navigation-bar-middle-sub" href="./about.html">About</a>
            <a class="navigation-bar-middle-sub" href="./services.html">Services</a>
            <a class="navigation-bar-middle-sub" href="./orders.html">Orders</a>
        </div>
    ...
    <main>
        <aside>
            <div>
                ...
                <a class="order-nav" href="./orders-orders.html">Orders</a>
                <a class="order-nav-select" href="./orders-profile.html">Profile</a>
        ...
        <section class="sectionCon">
            <div class="profile-con">
                ...
                <div class="col">
                    ...
                    <div class="for">Yang</div>
                </div>
                <div class="col">
                    <div class="profile-label">First&nbsp;Name</div>
                    <div class="for">Ken David</div>
                </div>
                <div class="col">
                    <div class="profile-label">E-mail</div>
                     <div class="for">YangKenDavid999@gmail.com</div>
                </div>
            </div>
            ...
            <div class="profile-con">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div type="text" class="form-control mb-1">B66 L6</div>
                    </div>
                    <div class="form-group">
                        <div class="form-label">Street</div>
                        <div type="text" class="form-control">Catacutan</div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div type="text" class="form-control">Aspect</div>
                        </div>
                    <div class="form-group">
                        <div class="form-label">Province</div>
                        <div type="text" class="form-control mb-1">Nothern Pole</div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div type="text" class="form-control">Demacia</div>
                    </div>
                    <div class="form-group">
                        <div class="form-label">Zip Code</div>
                        <div type="text" class="form-control">9999</div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div type="tel" class="form-control" placeholder="09123456789 or 1234-6547">09123456789</div>
                    </div>
                </div>
